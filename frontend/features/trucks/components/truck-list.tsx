...
export function TruckList({ trucks, searchTerm, onEdit, onDelete, onReleaseTruck }: TruckListProps) {
          ...
          <CardHeader>
            <div className="flex items-start justify-between">
              <div>
                ...
                <CardDescription>
                  السنة: {truck.year || 'غير محدد'} | السعة: {truck.capacity || 'غير محدد'} طن
                </CardDescription>
              </div>
                ...
                <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3 space-y-2">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <span className="font-medium">{activeAssignment.quantity ?? '-'} طن</span>
                    </div>
                    <div>
                  ...
                  {onReleaseTruck && (
                    <div className="pt-1">
                      <Button
                        size="sm"
                        variant="default"
                        onClick={() => onReleaseTruck(activeAssignment.id)}
                      >
                        تحرير السيارة (إنهاء التوصيل)
                      </Button>
                    </div>
                  )}
                </div>
